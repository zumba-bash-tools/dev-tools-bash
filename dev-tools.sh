...
dev-xdebug-init() {
	...
	local apps=(netsuite admin api public rulesengineservice service userservice primer convention core onlineclassstudent connectservice connectpublic connectapi connectadmin)
	local nextport=9000
	local containers=()
	local ports=()
	local jobPort=9000
